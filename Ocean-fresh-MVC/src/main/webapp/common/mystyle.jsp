...
<%--
<!-- 引入ckplayer视频插件 -->
<script type="text/javascript" src="<%=request.getContextPath()%>/js/ckplayer/ckplayer/ckplayer.js"></script>
<!-- 引入ckplayer的js-->
<script type="text/javascript" src="<%=request.getContextPath()%>/js/ckplayer/ckplayer.min.js"></script>--%>
<!-- 引入jquery -->
